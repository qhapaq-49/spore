...
const TRANSLATIONS = {
  ...
  mealScoreSource: { ja: '料理素点の入力', en: 'Meal score input' },
  fromRecipe: { ja: '料理名・レベルから参照', en: 'From recipe and level' },
  recipe: { ja: '料理名', en: 'Recipe' },
  recipeLevel: { ja: 'レシピレベル', en: 'Recipe level' },
  curry: { ja: 'カレー・シチュー', en: 'Curries / Stews' },
  salad: { ja: 'サラダ', en: 'Salads' },
  dessert: { ja: 'デザート・ドリンク', en: 'Desserts / Drinks' },
